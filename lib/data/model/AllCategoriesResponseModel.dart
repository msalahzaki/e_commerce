...
class AllCategoriesResponseModel extends AllCategoriesEntity{
  AllCategoriesResponseModel({
      super.results,
    super.metadata,
    super.categoryEntity,});

  AllCategoriesResponseModel.fromJson(dynamic json) {
    results = json['results'];
    metadata = json['metadata'] != null ? MetadataResponseModel.fromJson(json['metadata']) : null;
    if (json['data'] != null) {
      categoryEntity = [];
      json['data'].forEach((v) {
        categoryEntity?.add(CategoryResponseModel.fromJson(v));
      });
    }
  }
...
class MetadataResponseModel extends Metadata{
  MetadataResponseModel({
      super.currentPage,
      super.numberOfPages,
      super.limit,});

  MetadataResponseModel.fromJson(dynamic json) {
